...
def loadTrainingData(inputRootFile,
    ...
    if '.pkl' in outputFileName:
        dfTrainData.to_pickle(outputFileName)
    if '.h5' in outputFileName:
        dfTrainData.to_hdf(outputFileName, key='df', mode='w')
...
if __name__=="__main__":
    ...
    df = loadTrainingData(inputRootFile = args.inputRootFile,
